	...
	choiceContainer.find("input:checked").each(function () {
		...
		switch (index){
			...
			case 5:
				...
				xaxis: {
					mode: "time",
					minTickSize: [1, "hour"],timeformat: "%H:%M:%S/%P",
			...
			case 6:
				...
				xaxis: {
					mode: "time",
					minTickSize: [1, "minute"],timeformat: "%M:%S/%P",
			   
					min: (new Date()).getTime()-720000,
                    max: (new Date()).getTime()
					//twelveHourClock: true
					}
				});  
			...
			case 7:
				...
				xaxis: {
					mode: "time",
					minTickSize: [1, "second"],timeformat: "%S/%P",
